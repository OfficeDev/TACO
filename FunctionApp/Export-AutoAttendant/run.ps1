...
$aa = Get-CsAutoAttendant -Name $AAName
...
If($aa.DefaultCallFlow.Menu.MenuOptions.CallTarget.Id -ne $null)
{
    ...
    Else
    {
        $BHTarget =  $($aa.DefaultCallFlow.Menu.MenuOptions.CallTarget.Id).split(":")[0]
    }
}
...
$BusinessHours = $aa.Schedules|where-object{$_.Name -eq "$AAName After Hours Schedule" -or $_.Name -eq "After hours $AAName"}
...
$output | Add-Member -MemberType NoteProperty -Name Name -Value $aa.Name
$output | Add-Member -MemberType NoteProperty -Name BHGreetingType -Value $BHGreetingType
$output | Add-Member -MemberType NoteProperty -Name BHGreetingAudio -Value $BHGreetingAudiofile
$output | Add-Member -MemberType NoteProperty -Name BHGreetingText -Value $BHGreetingText
$output | Add-Member -MemberType NoteProperty -Name BHAction -Value $BHAction
$output | Add-Member -MemberType NoteProperty -Name BHTarget -Value $BHTarget
$output | Add-Member -MemberType NoteProperty -Name BHEnableSharedVoicemailSystemPromptSuppression -Value $aa.DefaultCallFlow.Menu.MenuOptions.CallTarget.EnableSharedVoicemailSystemPromptSuppression
$output | Add-Member -MemberType NoteProperty -Name AHGreetingType -Value $AHGreetingType
$output | Add-Member -MemberType NoteProperty -Name AHGreetingAudio -Value $AHGreetingAudiofile.FileName
$output | Add-Member -MemberType NoteProperty -Name AHGreetingText -Value $AHGreetingText
$output | Add-Member -MemberType NoteProperty -Name AHAction -Value $AHAction
$output | Add-Member -MemberType NoteProperty -Name AHTarget -Value $AHTarget
$output | Add-Member -MemberType NoteProperty -Name AHEnableSharedVoicemailSystemPromptSuppression -Value $aa.DefaultCallFlow.Menu.MenuOptions.CallTarget.EnableSharedVoicemailSystemPromptSuppression
$output | Add-Member -MemberType NoteProperty -Name MondayExtraRange -Value $MondayExtraRange
$output | Add-Member -MemberType NoteProperty -Name MondayStartTime1 -Value $MondayStartTime1
$output | Add-Member -MemberType NoteProperty -Name MondayEndTime1 -Value $MondayEndTime1
$output | Add-Member -MemberType NoteProperty -Name MondayStartTime2 -Value $MondayStartTime2
$output | Add-Member -MemberType NoteProperty -Name MondayEndTime2 -Value $MondayEndTime2
$output | Add-Member -MemberType NoteProperty -Name TuesdayExtraRange -Value $TuesdayExtraRange
$output | Add-Member -MemberType NoteProperty -Name TuesdayStartTime1 -Value $TuesdayStartTime1
$output | Add-Member -MemberType NoteProperty -Name TuesdayEndTime1 -Value $TuesdayEndTime1
$output | Add-Member -MemberType NoteProperty -Name TuesdayStartTime2 -Value $TuesdayStartTime2
$output | Add-Member -MemberType NoteProperty -Name TuesdayEndTime2 -Value $TuesdayEndTime2
$output | Add-Member -MemberType NoteProperty -Name WednesdayExtraRange -Value $WednesdayExtraRange
$output | Add-Member -MemberType NoteProperty -Name WednesdayStartTime1 -Value $WednesdayStartTime1
$output | Add-Member -MemberType NoteProperty -Name WednesdayEndTime1 -Value $WednesdayEndTime1
$output | Add-Member -MemberType NoteProperty -Name WednesdayStartTime2 -Value $WednesdayStartTime2
$output | Add-Member -MemberType NoteProperty -Name WednesdayEndTime2 -Value $WednesdayEndTime2
$output | Add-Member -MemberType NoteProperty -Name ThursdayExtraRange -Value $ThursdayExtraRange
$output | Add-Member -MemberType NoteProperty -Name ThursdayStartTime1 -Value $ThursdayStartTime1
$output | Add-Member -MemberType NoteProperty -Name ThursdayEndTime1 -Value $ThursdayEndTime1
$output | Add-Member -MemberType NoteProperty -Name ThursdayStartTime2 -Value $ThursdayStartTime2
$output | Add-Member -MemberType NoteProperty -Name ThursdayEndTime2 -Value $ThursdayEndTime2
$output | Add-Member -MemberType NoteProperty -Name FridayExtraRange -Value $FridayExtraRange
$output | Add-Member -MemberType NoteProperty -Name FridayStartTime1 -Value $FridayStartTime1
$output | Add-Member -MemberType NoteProperty -Name FridayEndTime1 -Value $FridayEndTime1
$output | Add-Member -MemberType NoteProperty -Name FridayStartTime2 -Value $FridayStartTime2
$output | Add-Member -MemberType NoteProperty -Name FridayEndTime2 -Value $FridayEndTime2
$output | Add-Member -MemberType NoteProperty -Name SaturdayExtraRange -Value $SaturdayExtraRange
$output | Add-Member -MemberType NoteProperty -Name SaturdayStartTime1 -Value $SaturdayStartTime1
$output | Add-Member -MemberType NoteProperty -Name SaturdayEndTime1 -Value $SaturdayEndTime1
$output | Add-Member -MemberType NoteProperty -Name SaturdayStartTime2 -Value $SaturdayStartTime2
$output | Add-Member -MemberType NoteProperty -Name SaturdayEndTime2 -Value $SaturdayEndTime2
$output | Add-Member -MemberType NoteProperty -Name SundayExtraRange -Value $SundayExtraRange
$output | Add-Member -MemberType NoteProperty -Name SundayStartTime1 -Value $SundayStartTime1
$output | Add-Member -MemberType NoteProperty -Name SundayEndTime1 -Value $SundayEndTime1
$output | Add-Member -MemberType NoteProperty -Name SundayStartTime2 -Value $SundayStartTime2
$output | Add-Member -MemberType NoteProperty -Name SundayEndTime2 -Value $SundayEndTime2
